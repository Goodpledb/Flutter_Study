                    ...
                    children: [
                      ...
                      Switch(
                        ...
                        onChanged: (value) {
                          ...
                          if(value == false) {
                            setState(() {
                              addSwitchPreserve = addController.text;
                              addController.text = "";
                              addSwitch = value;
                            });
                          } else {
                            setState(() {
                              addController.text = addSwitchPreserve;
                              addSwitch = value;                              
                            });
                          }
                        }
                      ...
                      Switch(
                        ...
                        onChanged: (value) {
                          ...
                          if(value == false) {
                            setState(() {
                              subSwitchPreserve = subController.text;
                              subController.text = "";
                              subSwitch = value;
                            });
                          } else {
                            setState(() {
                              subController.text = subSwitchPreserve;
                              subSwitch = value;                              
                            });
                          }
                        }
                      ...
                      Switch(
                        ...
                        onChanged: (value) {
                          ...
                          if(value == false) {
                            setState(() {
                              mulSwitchPreserve = mulController.text;
                              mulController.text = "";
                              mulSwitch = value;
                            });
                          } else {
                            setState(() {
                              mulController.text = mulSwitchPreserve;
                              mulSwitch = value;                              
                            });
                          }
                        }
                      ...
                      Switch(
                        ...
                        onChanged: (value) {
                          ...
                          if(value == false) {
                            setState(() {
                              divSwitchPreserve = divController.text;
                              divController.text = "";
                              divSwitch = value;
                            });
                          } else {
                            setState(() {
                              divController.text = divSwitchPreserve;
                              divSwitch = value;                              
                            });
                          }
                        }
